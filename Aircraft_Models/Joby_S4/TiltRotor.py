...
def vehicle_setup():
    ...
    lift_rotor_nacelle_origins = [[1.305,5.000,1.320],[1.305,-5.000,1.320],[   5.326, 2.174,  2.608],[   5.326, -2.174,  2.608]] 
    ...
    rotor.tip_radius                      = 3.5/2
    rotor.hub_radius                      = 0.15*rotor.tip_radius
    rotor.number_of_blades                = 4
    rotor.design_tip_mach                 = 0.5   
    rotor.nacelle_angle                   = 90. *  Units.degrees
    rotor.number_of_engines               = net.number_of_lift_rotor_engines
    ...
    rotor.design_thrust                   = (Hover_Load)/(net.number_of_engines-1)
    rotor.symmetric                       = True   
    lift_rotor_origins                          = [[1.505,5.000,1.320],[1.505,-5.000,1.320],[   5.535, 2.174,  2.608],[   5.535, -2.174,  2.608]] 
