...
def main():
    ...
    generate_vehicle_geometry(simulated_days,flights_per_day,aircraft_range,reserve_segment,run_noise_model,
...
def generate_vehicle_geometry(simulated_days,flights_per_day,aircraft_range,reserve_segment,run_noise_model,
                     hover_noise_test,plot_geometry,recharge_battery,run_analysis,plot_mission,
                     control_points,N_gm_x,N_gm_y):   
