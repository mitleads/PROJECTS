# Tiltwing_Touch_Go_Simulation.py
# 
...
def main(): 
    ...
    max_x             = 2.28*Units.nm  # maxiumum x (longitudinal) coordinate of acoustic computational domain 
    ...
    for i in range(len(X_LIM)-1):
        for j in range(len(Y_LIM)-1): 
            ...
            base_mission      = Tiltwing_Missions.approach_departure_mission_setup(configs_analyses,vehicle,simulated_days,flights_per_day,
