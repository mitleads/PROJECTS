...
def stick_fixed_stability_and_drag_optimization_setup(): 
    ...
    problem.inputs = np.array([          
                  ...
                  [ 'mw_root_twist'               , 3.0   , 0.0  , 5.0   , 10. ,  1*Units.degree], 
                  [ 'mw_tip_twist'                , -1.0  , -4.0 , 0.0   , 10.  ,  1*Units.degree],
                  #[ 'mw_dihedral'                 , 7.5   , 3.0  , 8.0   , 10.  ,  1*Units.degree], 
                  ...
                  [ 'c_g_x'                       , 2.23  , 2.0  , 3.0   , 10   ,  1*Units.less],
