...
def main():
    ...
    #breakdown = weights.evaluate()     # DOES NOT WORK  
    ...
    tf = time.time()
    print ('Time taken: ' + str(round((tf-ti)))  + ' sec')
...
def vehicle_setup():
    ...
    root_airfoil.coordinate_file          = '../Aircraft_Models/Airfoils/B737a.txt'
    ...
    yehudi_airfoil.coordinate_file        = '../Aircraft_Models/Airfoils/B737b.txt'
    segment                               = SUAVE.Components.Wings.Segment()
    segment.tag                           = 'Yehudi'
    ...
    mid_airfoil.coordinate_file           = '../Aircraft_Models/Airfoils/B737c.txt'
    segment                               = SUAVE.Components.Wings.Segment()
    ...
    tip_airfoil.coordinate_file           = '../Aircraft_Models/Airfoils/B737d.txt'
    segment                               = SUAVE.Components.Wings.Segment()
    segment.tag                           = 'Tip'
    ...
    # plot vehicle 
    #plot_vehicle(vehicle, axis_limits = 15 ,plot_control_points = False) 
    #plt.show()  
...
def mission_setup(analyses):
    ...
    segment.true_course    = 36.87  * Units.degrees 
    segment.true_course    = 15   * Units.degrees 
    # add to mission
    mission.append_segment(segment)
    ...
    segment.true_course  = 135   * Units.degrees 
    ...
    segment.true_course  = 160   * Units.degrees 
