...
def design_SR1_prop():
    ...
    separator = os.path.sep
    rel_path  = os.path.dirname(ospath) + separator 
    airfoil_data.geometry_files     =  [ rel_path +'../Airfoils/NACA_65_215.txt',rel_path +'../Airfoils/NACA_15.txt']
    ...
    n                               = len(prop.twist_distribution)  
    airfoil_polar_stations[round(n*0.50):] = 1    
    airfoil_data.airfoil_polar_stations     = list(airfoil_polar_stations.astype(int) )     
