...
from New_Propellers_Rotors.design_SR2_4_blade_prop import design_SR2_4_blade_prop 
from New_Propellers_Rotors.design_SR2_8_blade_prop import design_SR2_8_blade_prop
from New_Propellers_Rotors.design_SR7_8_blade_prop import design_SR7_8_blade_prop 
from New_Propellers_Rotors.design_BO_105_prop      import design_BO_105_prop 
from New_Propellers_Rotors.design_Hubbard_prop     import design_Hubbard_prop     
from New_Propellers_Rotors.design_F8745D4_prop     import design_F8745D4_prop     
from New_Propellers_Rotors.design_DJI_9_4x5_prop   import design_DJI_9_4x5_prop   
from New_Propellers_Rotors.design_APC_11x_4_7_prop import design_APC_11x_4_7_prop   
from New_Propellers_Rotors.design_APC_11x45_prop   import design_APC_11x45_prop   
from New_Propellers_Rotors.design_APC_10x7_prop    import design_APC_10x7_prop 
from New_Propellers_Rotors.design_APC_11x8_prop    import design_APC_11x8_prop
from New_Propellers_Rotors.design_SR1_prop         import design_SR1_prop 
# ----------------------------------------------------------------------
#   Main
# ---------------------------------------------------------------------- 
def main():  
...
def Broadband_Spectrum_Shape_Sensitivity(PP,save_figures):
    ...
    for var_idx in range(len(sensitivity_variables)):
        ...
        for idx in range(len(M)):
            ...
            airfoil_geometry        = compute_naca_4series(['0012'],npoints=npanel) 
...
def Broadband_Spectrum_Validation(PP,save_figures):
    ...
    airfoil_geometry        = compute_naca_4series(['0012'],npoints=npanel) 
    airfoil_stations        = [0] * num_sec
    AP                      = airfoil_analysis(airfoil_geometry,AoA_batch,Re_batch, airfoil_stations = airfoil_stations)     
    ...
    surface_dcp_dx          = AP.dcp_dx*0.5*rho*(V_inf**2)/chord
