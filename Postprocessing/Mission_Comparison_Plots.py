...
def set_up_axes(figure_width,figure_height):
    ...
    axins_1 = axes_1.inset_axes([0.2, 0.05, 0.5, 0.40])
    axins_1.set_xlim(-0.002, 0.03) # apply the x-limits
    axins_1.set_ylim(0, 80) # apply the y-limits    
    axins_1.xaxis.set_visible(False)
    axins_1.yaxis.set_visible(False) 
    axins_1.indicate_inset([0.2, 0.05, 0.5, 0.40],edgecolor = 'black', alpha=1.0,linewidth =2)    
    ...
    axins_12.set_ylim(0, 7) # apply the y-limits    
    ...
    axes_14.set_ylim(0.55,1.02)   
    fig_14.tight_layout()          
    axes_14.text(0.0, 0.92, "1", size=20, ha="center", va="center", color= "black", bbox=dict(facecolor = 'white', boxstyle="circle") )  
    axes_14.text(0.99, 0.68, "2", size=20, ha="center", va="center",color= "black", bbox=dict(facecolor = 'white',boxstyle="circle") )  
    ...
    axes_19.set_ylabel(r'$\eta_{mot}$') 
    axes_19.set_ylim(0.75, 1.05)             
...
def plot_reserve_mission_results(res,PP):
    ...
    fig_22.savefig("Reserve_Mission_Battery_Pack_Performance_C_rate.pdf") 
