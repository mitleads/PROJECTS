...
def main():  
    ...
    #rotor_0.freestream_velocity           = np.sqrt(rotor_0.design_thrust/(2*1.2*np.pi*(rotor_0.tip_radius**2))) # IDEAL POWER 
    #rotor_0.freestream_velocity          = rotor_0.inflow_ratio*rotor_0.angular_velocity*rotor_0.tip_radius  #INFLOW RATIO
    ...
    SR_lift_rotor_design_comparisons(alpha_weights,use_pyoptsparse,plot_parameters,save_figures)
...
def SR_lift_rotor_single_design_point(rotor_0,alpha_weights,use_pyoptsparse_flag, plot_rotor_geomery_and_performance,plot_parameters,save_figures): 
    ...
    for i in range(len(alpha_weights)):
        ...
        rotor.airfoil_geometry           = [ '../../Aircraft_Models/Airfoils/NACA_4412.txt']
        rotor.airfoil_polars             = [['../../Aircraft_Models/Airfoils/Polars/NACA_4412_polar_Re_50000.txt',
...
def SR_lift_rotor_design_comparisons(alpha_weights,use_pyoptsparse_flag,PP,save_figures):   
    ...
    fig_1_name = "Thrust_LR_Rotor_Comparison" 
    fig_2_name = "Torque_LR_Rotor_Comparison" 
    fig_3_name = "Blade_Re_LR_Rotor_Comparison"  
    fig_4_name = "Blade_AoA_LR_Rotor_Comparison" 
    fig_5_name = 'SPL_LRv_Rotor_Comparison'   
